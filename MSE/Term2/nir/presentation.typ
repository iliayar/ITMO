...
#slide([Существующие решение и требования])[
  ...
  - Мета-информацию для конкретного узла
...
#slide([Результаты и выводы])[
  - Реализован прототип инструмента для интерактивного отображения рассахаренного AST#footnote[https://gitcode.com/iliayar/cjexplore]
  ...
  - Аналогичная функциональность для промежуточного представления CHIR
]
