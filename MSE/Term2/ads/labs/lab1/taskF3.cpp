...
// Generated at 2026-02-15 14:12:11.145726 
// By iliayar
...
//entry
void sol() {
    int n, m, s; double v; cin >> n >> m >> s >> v; s--;
    vector<vector<E>> g(n, vector<E>());

    for (int i = 0; i < m; ++i) {
        int u, v; cin >> u >> v; u--; v--;
        double r, c, rt, ct; cin >> r >> c >> rt >> ct;
        g[u].emplace_back(v, r ,c);
        g[v].emplace_back(u, rt, ct);
    }
