...
// Generated at 2026-04-05 02:03:37.256772 
// By iliayar
...
bool approx(double a, double b) {
    return b - numeric_limits<double>::epsilon() <= a && a <= b + numeric_limits<double>::epsilon();
}

pair<mat, vint> gauss(mat const& A) {
    int n = A.size();
    int m = A[0].size();
    mat res;
    vint p;
