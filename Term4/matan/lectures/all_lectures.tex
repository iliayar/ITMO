...
\end{proof}
\section{Интеграл}
\label{sec:orgb563dc9}
\subsection{Измеримые функции}
\label{sec:orgc1ccb17}
\begin{definition}
\-
\begin{enumerate}
...
\end{definition}
\chapter{}
\label{sec:orgafa6097}
\newcommand{\X}{\mathcal{X}}
\newcommand{\A}{\mathfrak{A}}

\section{Теореия меры}
\label{sec:org8eb94d8}
\subsection{Измеримые функции}
\label{sec:orgbef497c}
\begin{itemize}
\item \((X, \A, \mu)\)
...
\end{theorem}
\chapter{}
\label{sec:orgb2c1292}
\newcommand{\X}{\mathcal{X}}
\newcommand{\A}{\mathfrak{A}}

\section{Интеграл}
\label{sec:org2bdc79a}
\begin{enumerate}
...
\label{sec:orgb932241}
\subsection{Замена перменных в интеграле}
\label{sec:org50f5c37}
\begin{itemize}
\item \((X, \A, mu)\)
\item \((Y, \B, \cdot)\)
\item \(\Phi: X \to Y\)
...
\item По \hyperref[org6ab8a1e]{лемме} второе неравенство \ref{5_3_neq} выполнено для всех измеримых \(A\)
