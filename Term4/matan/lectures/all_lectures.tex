...
\end{proof}
\section{Интеграл}
\label{sec:org4c061a4}
\subsection{Измеримые функции}
\label{sec:org40fc307}
\begin{definition}
\-
\begin{enumerate}
...
\end{definition}
\chapter{}
\label{sec:orge52ed0d}
\newcommand{\X}{\mathcal{X}}
\newcommand{\A}{\mathfrak{A}}

\section{Теореия меры}
\label{sec:orgdc48793}
\subsection{Измеримые функции}
\label{sec:org279dda6}
\begin{itemize}
\item \((X, \A, \mu)\)
...
\end{theorem}
\chapter{}
\label{sec:orge729d51}
\newcommand{\X}{\mathcal{X}}
\newcommand{\A}{\mathfrak{A}}

\section{Интеграл}
\label{sec:org34158cb}
\begin{enumerate}
...
\label{sec:org2cb9b4c}
\subsection{Замена перменных в интеграле}
\label{sec:org69e6011}
\begin{itemize}
\item \((X, \A, mu)\)
\item \((Y, \B, \cdot)\)
\item \(\Phi: X \to Y\)
...
\item По \hyperref[org8876b45]{лемме} второе неравенство \ref{5_3_neq} выполнено для всех измеримых \(A\)
...
\end{remark}
\begin{remark}
Для \hyperref[orgf7d485e]{замечания 1} и \hyperref[org6a1bef5]{замечания 2} требуется инвариантность меры относительно движения \(\R^m\)
\end{remark}
