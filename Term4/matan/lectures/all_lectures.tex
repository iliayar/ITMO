...
\end{proof}
\section{Интеграл}
\label{sec:orgc09d42f}
\subsection{Измеримые функции}
\label{sec:org8253d04}
\begin{definition}
\-
\begin{enumerate}
...
\end{definition}
\chapter{}
\label{sec:org025fff5}
\newcommand{\X}{\mathcal{X}}
\newcommand{\A}{\mathfrak{A}}

\section{Теореия меры}
\label{sec:orgbb347ed}
\subsection{Измеримые функции}
\label{sec:orga450792}
\begin{itemize}
\item \((X, \A, \mu)\)
...
\end{theorem}
\chapter{}
\label{sec:orgfbd8a0c}
\newcommand{\X}{\mathcal{X}}
\newcommand{\A}{\mathfrak{A}}

\section{Интеграл}
\label{sec:org514a333}
\begin{enumerate}
...
\label{sec:org78c6701}
\subsection{Замена перменных в интеграле}
\label{sec:org454724d}
\begin{itemize}
\item \((X, \A, mu)\)
\item \((Y, \B, \cdot)\)
\item \(\Phi: X \to Y\)
...
\item По \hyperref[orge9a64ad]{лемме} второе неравенство \ref{5_3_neq} выполнено для всех измеримых \(A\)
