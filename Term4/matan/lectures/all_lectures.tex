% Created 2021-03-16 Tue 19:00
% Intended LaTeX compiler: pdflatex

  \documentclass[russ,oneside]{book}
...
\end{proof}
\section{Интеграл}
\label{sec:org91bd6e1}
\subsection{Измеримые функции}
\label{sec:org7060c04}
\begin{definition}
\-
\begin{enumerate}
...
\item По \hyperref[orga899fb2]{лемме} второе неравенство \ref{5_3_neq} выполнено для всех измеримых \(A\)
