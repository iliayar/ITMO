...
\end{definition}
\chapter{}
\label{sec:orgcb42787}
\newcommand{\X}{\mathcal{X}}
\newcommand{\A}{\mathfrak{A}}

\section{Теореия меры}
\label{sec:org479e7a6}
\subsection{Измеримые функции}
...
\end{theorem}
\chapter{}
\label{sec:orgf3476ca}
\newcommand{\X}{\mathcal{X}}
\newcommand{\A}{\mathfrak{A}}

\section{Интеграл}
\label{sec:org703e903}
\begin{enumerate}
...
\item По \hyperref[org5fe879d]{лемме} второе неравенство \ref{5_3_neq} выполнено для всех измеримых \(A\)
...
\end{remark}
\begin{remark}
Для \hyperref[org9d9ebae]{замечания 1} и \hyperref[orge79a16b]{замечания 2} требуется инвариантность меры относительно движения \(\R^m\)
\end{remark}
...
\end{corollary}
\section{Ряды Фурье}
\label{sec:orgafbeda9}
\subsection{Пространства \(L^p\)}
\label{sec:orga8f338f}
\begin{property}
\-
\begin{itemize}
\item \((X, \A, \mu)\)
...
Те-же условия что и в \hyperref[orgbf01b7b]{Неравенстве Гельдера}
