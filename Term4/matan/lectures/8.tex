...
\end{corollary}
\section{Ряды Фурье}
\label{sec:org1b40256}
\subsection{Пространства \(L^p\)}
\label{sec:orgdf581c6}
\begin{property}
\-
\begin{itemize}
\item \((X, \A, \mu)\)
...
Те-же условия что и в \hyperref[orgb80c6c0]{Неравенстве Гельдера}
