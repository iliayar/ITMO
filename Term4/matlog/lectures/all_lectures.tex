...
\chapter{TODO}
\label{sec:org6c6f459}
\chapter{TODO}
\label{sec:org857e8b0}
\chapter{TODO}
\label{sec:org53b15a9}
\chapter{5 марта}
\label{sec:org2884259}
...
\end{proof}
\chapter{12 марта}
\label{sec:orgb2949d9}
\section{Программы}
\label{sec:orgeb7bede}
программа(функция)
\begin{itemize}
...
\end{examp}
\chapter{19 марта}
\label{sec:org08594df}
\section{Исчисление предикатов}
\label{sec:orgea935b7}
\subsection{Расставление скобок}
\label{sec:org6404c61}
...
\end{corollary}
\chapter{9 апреля}
\label{sec:org3ff5eb5}
\section{Исчесление предиктов}
\label{sec:orgb2364e2}
