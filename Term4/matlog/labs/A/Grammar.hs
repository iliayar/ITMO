...
happyExpList = Happy_Data_Array.listArray (0,31) ([1408,28760,22528,1408,28672,22528,1408,28760,2,0,4103,0,0
	])

{-# NOINLINE happyExpListPerState #-}
happyExpListPerState st =
    token_strs_expected
  where token_strs = ["error","%dummy","%start_parseExpr","Expr","and","or","impl","not","'('","')'","var","%eof"]
...
action_14 (5) = happyShift action_7
