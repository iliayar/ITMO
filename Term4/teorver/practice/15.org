...
\[ \varphi_{\frac{\xi_\lambda - \lambda}{\sqrt{\lambda}}} = \varphi_{\xi_\lambda - \lambda}\left\left(\frac{t}{\sqrt{\lambda}}\right\right) = \exo\left(\lambda\left(e^{i\frac{t}{\sqrt{\lambda}}} - i\cdot \frac{t}{\sqrt{\lambda}} - 1\right)\right) = \]
