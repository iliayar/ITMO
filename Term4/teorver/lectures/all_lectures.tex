...
\chapter{}
\label{sec:orgee626b9}
\section{Статистическая вероятность}
\label{sec:orge2e3ae9}
...
\end{solution}
\chapter{}
\label{sec:orgc181742}
\section{Условная вероятность}
\label{sec:org7997768}
\begin{symb}
...
\end{solution}
\chapter{}
\label{sec:orgfff5e08}
\section{Схема Бернулли}
\label{sec:org49cec4c}
\begin{definition}
