...
\chapter{}
\label{sec:org49b9aca}
\section{Статистическая вероятность}
\label{sec:org5952996}
...
\end{solution}
\chapter{}
\label{sec:org3668ada}
\section{Условная вероятность}
\label{sec:org14a0b98}
\begin{symb}
...
\end{solution}
\chapter{}
\label{sec:orgbb77373}
\section{Схема Бернулли}
\label{sec:orgcedeac5}
\begin{definition}
...
\end{remark}
\begin{examp}
\hyperref[org48f699d]{Бросаем кость}
...
\end{remark}
\begin{proof}
По \hyperref[org40d26a5]{свойству} \(\text{Cov}(\xi, \eta) = 0\)
\end{proof}
\begin{remark}
...
\end{proof}
\begin{property}
Если \(F(x)\) непрерывна в точке \(x_0\), то \(p(\xi = 0) = 0\). Следствие из \ref{org514dcc3}
\end{property}
\begin{property}
...
\end{property}
\begin{proof}
Из определения или из \ref{org7621a83}
\end{proof}
\begin{property}
\(p(\xi = x_0) = 0\)
\end{property}
...
\end{property}
\begin{property}
Если для \(f(x)\) выолнено свойства \ref{orgc3066f1} и \ref{org7be07fa} то она является плотностью некоторой случайной величины
\end{property}
\subsection{Числовые характеричтики}
\label{sec:org748cd0c}
\begin{definition}
