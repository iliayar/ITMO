...
\chapter{}
\label{sec:orgd210744}
\section{Статистическая вероятность}
\label{sec:orgfb8d504}
...
\end{solution}
\chapter{}
\label{sec:org17a4652}
\section{Условная вероятность}
\label{sec:orgd5ae596}
\begin{symb}
...
\end{solution}
\chapter{}
\label{sec:orga5d802f}
\section{Схема Бернулли}
\label{sec:org8b6c5ae}
\begin{definition}
...
\end{remark}
\begin{examp}
\hyperref[org73ca4f3]{Бросаем кость}
...
\end{remark}
\begin{proof}
По \hyperref[org233baa1]{свойству} \(\text{Cov}(\xi, \eta) = 0\)
\end{proof}
\begin{remark}
...
\end{proof}
\begin{property}
Если \(F(x)\) непрерывна в точке \(x_0\), то \(p(\xi = 0) = 0\). Следствие из \ref{orgccd1691}
\end{property}
\begin{property}
...
\end{property}
\begin{proof}
Из определения или из \ref{orgd2b14e8}
\end{proof}
\begin{property}
\(p(\xi = x_0) = 0\)
\end{property}
...
\end{property}
\begin{property}
Если для \(f(x)\) выолнено свойства \ref{org32fd555} и \ref{org13ee6f0} то она является плотностью некоторой случайной величины
\end{property}
\subsection{Числовые характеричтики}
\label{sec:org6a30d14}
\begin{definition}
