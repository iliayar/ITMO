...
\chapter{}
\label{sec:orga87884d}
\section{Статистическая вероятность}
\label{sec:org5542282}
...
\end{solution}
\chapter{}
\label{sec:org570548f}
\section{Условная вероятность}
\label{sec:org77b4235}
\begin{symb}
...
\end{solution}
\chapter{}
\label{sec:org7f30711}
\section{Схема Бернулли}
\label{sec:orgd9dee8d}
\begin{definition}
...
\end{remark}
\begin{examp}
\hyperref[org3d6f15e]{Бросаем кость}
...
\end{remark}
\begin{proof}
По \hyperref[org73456c2]{свойству} \(\text{Cov}(\xi, \eta) = 0\)
\end{proof}
\begin{remark}
...
\end{proof}
\begin{property}
Если \(F(x)\) непрерывна в точке \(x_0\), то \(p(\xi = 0) = 0\). Следствие из \ref{orgde518f6}
\end{property}
\begin{property}
...
\end{property}
\begin{proof}
Из определения или из \ref{orgb9156a9}
\end{proof}
\begin{property}
\(p(\xi = x_0) = 0\)
\end{property}
...
\end{property}
\begin{property}
Если для \(f(x)\) выолнено свойства \ref{orgab31892} и \ref{orge215ade} то она является плотностью некоторой случайной величины
\end{property}
\subsection{Числовые характеричтики}
\label{sec:org41399f5}
\begin{definition}
