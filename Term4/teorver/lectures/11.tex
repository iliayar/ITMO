...
\section{Совместное распределение случайных величин}
\label{sec:org350c48c}
\begin{definition}
\textbf{Случайным вектором} \(\xi_1, \xi_2, \dots, \xi_n\) называется упорядоченный набор случайных величин, заданных на одном вероятностном пространстве \(\Omega, \mathcal{F}, p\)
\end{definition}
\end{document}
