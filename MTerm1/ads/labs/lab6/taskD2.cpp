...
// Generated at 2025-06-21 21:28:54.605636 
// By iliayar
...
void sol() {
    ...
    sort(ALL(d), [](const auto& lhs, const auto& rhs) { return lhs.v < rhs.v; });
    sort(ALL(c), [](const auto& lhs, const auto& rhs) { return rhs.v < lhs.v; });
