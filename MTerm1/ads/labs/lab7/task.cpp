...
// Generated at 2025-07-03 00:02:22.913889 
// By iliayar
...
void sol() {
    int n1; cin >> n1;
    vint a1(n1); for (auto& i : a1) cin >> i;
    int n2; cin >> n2;
    vint a2(n2); for (auto& i : a2) cin >> i;
    int n3; cin >> n3;
    vint a3(n3); for (auto& i : a3) cin >> i;

    vector<vint2> dp(n1 + 1, vint2(n2 + 1, vint(n3 + 1, 0)));

    for (int i = 1; i <= n1; ++i) {
        for (int j = 1; j <= n2; ++j) {
            for (int k = 1; k <= n3; ++k) {
                if (a1[i-1] == a2[j-1] && a2[j-1] == a3[k-1]) {
